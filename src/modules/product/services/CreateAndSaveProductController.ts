...
class CreateAndSaveProductController {
    ...
    async handle(req: Request, res: Response) {
        ...
        const { product_name, code, bar_code, size, quantity, cost, price, url_img, status, category } = req.body;

        const createAndSaveProductService = container.resolve(CreateAndSaveProductService);
